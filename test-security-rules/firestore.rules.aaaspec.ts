...
console.log("Current directory path.resolve:", path.resolve(__dirname));
console.log("xxx:", path.resolve('firestore.test.rules'));

const projectId = 'demo-1';
const rules = fs.readFileSync(path.resolve(__dirname, 'firestore.test.rules'), 'utf8');
